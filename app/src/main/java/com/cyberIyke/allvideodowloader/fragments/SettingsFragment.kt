...
import com.cyberIyke.allvideodowloader.fragments.base.MyPreferences
...
class SettingsFragment : BaseFragment(), OnBackPressedListener, View.OnClickListener {
    ...
    private lateinit var darkSwitch: SwitchButton
    ...
    override fun onCreateView(
        ...
        if (mView == null) {
            ...
            darkSwitch = mView!!.findViewById(R.id.darkModeSwitch)
            rootView = mView!!.findViewById(R.id.rootLayout)
            darkSwitch.isChecked = MyPreferences(requireContext()).darkMode == 1

            darkSwitch.setOnCheckedChangeListener(object : SwitchButton.OnCheckedChangeListener {
...
//        if (isChecked) {
//            AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES)
//            MyPreferences(requireContext()).darkMode = 1  // Store dark mode preference
//        } else {
//            AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO)
//            MyPreferences(requireContext()).darkMode = 0  // Store light mode preference
//        }
